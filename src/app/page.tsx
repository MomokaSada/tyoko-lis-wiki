          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-3">
              {recentPosts.length === 0 ? (
                <p className="text-stone-500 p-4 border border-stone-200 rounded-2xl bg-stone-50">まだ公開されている項目が存在しません。</p>
              ) : (
              ...
              <div className="relative overflow-visible">
                ...
                <Link href={`/posts/${featuredPost.slug}`} className="relative z-10 bg-stone-900 rounded-[2.25rem] p-6 md:p-8 text-white overflow-hidden aspect-4/5 flex flex-col justify-end group cursor-pointer shadow-xl shadow-stone-200/20 hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <div className="absolute inset-0 z-0">
                    <Image src={getPublicThumbnailUrl(featuredPost.thumbnail) || '/images/no-image.png'} alt={featuredPost.title} fill unoptimized className="object-cover opacity-50 group-hover:opacity-70 transition-opacity duration-700" />
